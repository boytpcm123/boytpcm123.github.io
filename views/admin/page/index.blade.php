        ...
        <div class="card">
            <div class="header">
                <a href="{!! route("admin.page.create") !!}" class="btn btn-info waves-effect pull-right">
                    ...
                    <span>{!! trans("admin_menu.create_custom_page") !!}</span>
                </a>
                <span class="pull-right">&nbsp;&nbsp;</span>
                <a href="{!! route("admin.page.static.create") !!}" class="btn btn-info waves-effect pull-right">
                    <i class="material-icons">add</i>
                    <span>{!! trans("admin_menu.create_static_page") !!}</span>
                </a>
                <h2>
            ...
            <div class="body">
                ...
                <table id="datatable" class="table table-bordered table-striped table-hover dataTable" style="width: 100%">
                    <thead>
                    <tr>
                        <th width="40">{!! trans("admin_page.table.id") !!}</th>
                        <th>{!! trans("admin_page.table.type") !!}</th>
...
@section("script")
    ...
    <script type="text/javascript" src="/assets/admin/js/pages/page.index.js"></script>
@endsection